...
function PagePost:new(page, i, x, y, pox, poy)
  ...
  obj.like.ib = IconButton:new(icons.like, function() obj.like.clicked = not obj.like.clicked end,
    ...
    poy)
  obj.comment = {
    ib = IconButton:new(icons.message, function() print("comment pressed") end, obj.content.default_x + 475,
  ...
  function obj:update(dt)
    ...
    obj.tone = 0
    if is_mouse_hover(obj.content.oi_x, obj.content.oi_y, obj.content.oi_w, obj.content.oi_h, pox, poy, page.post_trans) then
